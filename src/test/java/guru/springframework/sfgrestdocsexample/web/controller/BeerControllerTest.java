...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        ...
        // look we changed the path adding a path-variable. Also, its value is passed as parameter and no more as string append
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID())
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                // RestDoc path-variable documentation
        ...
        mockMvc.perform(post("/api/v1/beer")
                ...
                .andDo(document("v1/beer-new",
                        requestFields(
                                ...
                                fields.withPath("upc").description("Style of the beer"),
                                fields.withPath("price").description("Style of the beer"),
